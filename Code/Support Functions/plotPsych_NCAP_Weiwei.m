function [fitValues] = plotPsych_NCAP_Weiwei(result,plotOptions)
...
if ~isfield(plotOptions,'xLabel'),         plotOptions.xLabel         = 'Target shift (degrees)';    end
if ~isfield(plotOptions,'yLabel'),         plotOptions.yLabel         = '% forw resps';end
